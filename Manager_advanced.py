...
class Manager:
    ...
    def __init__(self):
        ...
        self.ballList = []
        self.numBall = 5 # now makes 5 balls.
        self.enemyList = []
        self.numEn = 3 # now makes 3 enemies.
        ...
        self.main() # run the game at instantiation
    
    def checkCollisions(self):
        for ball in self.ballList:
            # check for value in attribute 
            if ball.collided(self.enemy):
        ...
        for enemy in self.enemyList:
            if (enemy.clicked): 
                ...
                if (random.random()>0.5):
                    # 50% chance of generating an Enemy object with a Ball object
                    self.enemyList.append(Enemy())
                enemy.clicked = False # turn off signal
    ...
    def main(self):
        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                self.enemyList[0].click(event) # calling the subclass method, which has 2 arguments
