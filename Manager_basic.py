...
The Manager class can also:
    ...
    - have other game tools as objects:
        timer, score, lives, color/speed/settings toggling
'''
...
class Manager:
    ...
    # gameOver method needs ballList to adjust (inside main function)
    def gameOver(self, ballList):
    ...
    def main(self):
        ...
        ball = Ball(w/2-100,h/2) # make single ball object
        enemy = Enemy() # make single enemy object
        
        numBalls = 2
        
        # make list of ball objects at random locations
        ballList = [] 
        ...
        while running:
            ...
            # test.show()
            enemy.move(7) # draw the enemy objects; they move faster
            ...
            for event in pygame.event.get():
                ...
                enemy.click(event) # calling the subclass method, which has 2 arguments
                
                self.checkClicked(ballList)   # checks ballList for win condition         
